    ...
    <div class="rp_plugin">
        ...
        if ($show_social_buttons) { ?>
            ...
            <div class="rp_socialButtons_<?php echo $id;?>" style="width:<?php echo $atts['width'];?>;">
                <button style="width: 33.3%; padding-top: 10px; padding-bottom: 10px; color: #FFFFFF; margin: 0px; display: inline-block; background: #3370AA; font-weight: bold; font-size: 13px;" onclick="shareFacebook();"><img src="<?php echo PLP_IMAGES_URL; ?>facebook-24x24.png" style="vertical-align: middle; margin-right: 2px;" /> Facebook</button><button style="width: 33.3%; padding-top: 10px; padding-bottom: 10px; color: #FFFFFF; margin: 0px; display: inline-block; background: #0BBCFF; font-weight: bold; font-size: 13px;" onclick="shareTwitter();"><img src="<?php echo PLP_IMAGES_URL; ?>twitter-24x24.png" style="vertical-align: middle; margin-right: 5px;" /> Twitter</button><button style="width: 33.4%; padding-top: 10px; padding-bottom: 10px; color: #FFFFFF; margin: 0px; display: inline-block; background: #D6492B; font-weight: bold; font-size: 13px;" onclick="shareGooglePlus();"><img src="<?php echo PLP_IMAGES_URL; ?>google+-24x24.png" style="vertical-align: middle; margin-right: 5px;" /> Google+</button>
            </div>
